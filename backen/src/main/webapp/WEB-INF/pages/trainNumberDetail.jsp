...
<div id="dialog-numberDetail-form" style="display: none;">
    <form id="numberDetailForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                <td><label for="relativeTime">相对出发时间</label></td>
                <td>
                    <input type="text" name="relativeTime" id="relativeTime" value=""
                           class="text ui-widget-content ui-corner-all">
                </td>
            </tr>
            <tr>
                <td><label for="waitTime">到站等待时间</label></td>
                <td>
                    <input type="text" name="waitTime" id="waitTime" value=""
                           class="text ui-widget-content ui-corner-all">
                </td>
            </tr>
            <tr>
